...
The History tab may also expose a separate WWII control scenario for explaining
territorial expansion and contraction over a shorter timeline. That scenario
uses CShapes-Europe country outlines as source geometry, but its moving internal
control boundaries are generated by campaign-phase clipping. It must therefore
be labeled as illustrative and non-authoritative.
